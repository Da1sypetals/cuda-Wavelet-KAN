...
torch::Tensor morlet_fwd(torch::Tensor x, torch::Tensor scale, torch::Tensor bias, torch::Tensor weight)
{
...
Tensor4 morlet_bwd(torch::Tensor gout, torch::Tensor x, torch::Tensor scale, torch::Tensor bias, torch::Tensor weight)
{
...
{
    m.def("forward", &morlet_fwd, "morlet forward");
    m.def("backward", &morlet_bwd, "morlet backward");
}